...
- php version 8.3.10 - [https://secure.php.net/ChangeLog-8.php](https://secure.php.net/ChangeLog-8.php)
- composer version 2.7.8 [https://getcomposer.org/download/](https://getcomposer.org/download/)
- default.conf update
- Dockerfile update
- README update
- index.php update
